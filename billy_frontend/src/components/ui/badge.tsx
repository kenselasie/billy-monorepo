  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 shadow-sm",
  {
    variants: {
      variant: {
        ...
        outline: "text-black bg-white border-gray-300 hover:bg-gray-50 hover:shadow-md dark:text-white dark:bg-neutral-800 dark:border-neutral-600 dark:hover:bg-neutral-700",
      },
    },
    defaultVariants: {
      variant: "default",
